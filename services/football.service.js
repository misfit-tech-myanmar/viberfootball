...
FootBallService.prototype = {
    getFixtureFromApiAndPostToMyaliceDataLab: async(from, to) => {
        const footballResponse = await axios.get(`https://apiv3.apifootball.com/?action=get_events&from=${from}&to=${to}&league_id=152&APIkey=34f577c68ef6389ab7aa95503798cfb56eefda08394eea05ae76bbebbad18914&timezone=Asia/Yangon`);
    ...
    addTeamToMyalice: async() => {
        return new Promise(async(resolve, reject)=> {
            try{
                const teamsResponse = await axios.get('https://apiv3.apifootball.com/?action=get_teams&league_id=152&APIkey=34f577c68ef6389ab7aa95503798cfb56eefda08394eea05ae76bbebbad18914&timezone=Asia/Yangon')
